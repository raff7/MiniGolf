...
public class Tester {
	public static void main(String[] arg){
		...
		Vector3f p13 = new Vector3f(5,0,2);
		Vector3f p14 = new Vector3f(5,0,3);
		...
		Node node5 = new Node(triangle5,"5");
		Node node6 = new Node(triangle6,"6");
		Node node7 = new Node(triangle7,"7");
		Node node8 = new Node(triangle8,"8");
...
//			nodesList.add(new Node(new Triangle(new Vector3f(getNumber(),getNumber(),getNumber()),new Vector3f(getNumber(),getNumber(),getNumber()),new Vector3f(getNumber(),getNumber(),getNumber())),"a"));
//		}
		//SampleCourse.getCourse(new Loader());
